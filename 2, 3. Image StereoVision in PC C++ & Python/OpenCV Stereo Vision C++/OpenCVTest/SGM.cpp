...
{
	const int DISP_SCALE = SGM::DISP_SCALE;
	const int DISP_INV = SGM::DISP_INV;
...
{
	const int DISP_SHIFT = SGM::DISP_SHIFT;
	const int DISP_INV = SGM::DISP_INV;
...
SGM::SGM(const Parameters& param) : param_(param)
{
}

void SGM::compute(const cv::Mat& I1, const cv::Mat& I2, cv::Mat& D1, cv::Mat& D2)
{
